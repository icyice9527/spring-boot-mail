...
CREATE TABLE `mail_list` (
  ...
  `email` varchar(500) NOT NULL COMMENT '联系人邮箱',
  `phone` varchar(20) DEFAULT NULL COMMENT '电话号码',
  `note` text DEFAULT NULL COMMENT '备注',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '联系人创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

insert  into `mail_list`(`id`,`name`,`email`,`phone`,`note`) values (8,'villa','djcgrim@foxmail.com','18728662784','很帅')